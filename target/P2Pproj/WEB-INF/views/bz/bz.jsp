        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" id="formadd">
                <div class="form-group">
                    <label class="col-sm-3 control-label">标种名称：</label>
                    <div class="col-sm-8">
                        <input type="text" id="bzname" name="bzname" class="form-control" required="" aria-required="true"/>
                    </div>
                </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal"  id="updateForm">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">标种名称:</label>
                        <div class="col-sm-8">
                            <input type="text"  name="bzname" class="form-control" required="" aria-required="true"/>
                        </div>
                    </div>
...
<script src="<%=path%>/static/js/pageJs/bz.js"></script>
