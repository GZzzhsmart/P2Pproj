...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <form class="form-horizontal"  action="<%=path%>/media/update" id="updateForm">
                <input type="hidden" name="mid" id="mid" value="${media.mid}"/>
                <input type="hidden" name="state" id="state" value="${media.state}"/>
                <div class="form-group">
                    <label class="col-sm-2 control-label">标题</label>
                    <div class="col-sm-10">
                        <input type="text" name ="title" value="${media.title}" placeholder="" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">内容</label>
                    <div class="col-sm-10">
                        <script type="text/plain" id="editor" name="content" value="${media.content}">${media.content}</script>
                    </div>
                </div>
                <input type="hidden" id="pic" name="pic" value="${media.pic}"/>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input name="date" type="date" value="${media.date}" placeholder="" class="form-control">
                    </div>
                </div>
                <div class="form-group">
