    ...
    <div class="w1200 personal">
        ...
        <div class="personal-main">
            <div class="personal-pay">
                ...
                <form id="form" name="form" method="post" action="<%=path%>/luser/userdataUpdate">
                    ...
                    <div class="pay-form">
                        ...
                        <ul>
                            <li>
                                ...
                                <input type="text"  class="pay-txt"  name="uname" id="uname" disabled  value="${user.uname}"  placeholder="请输入您的用户名">
                                <div id="xls"></div>
                            </li>
                            <li>
                                <label for="realname">手机号</label>
                                <input type="text"  class="pay-txt" id="phone" name="phone" value="${user.phone}"  placeholder="请输入您的手机号">
                                <div id="bs"></div>
                            </li>
                            <li>
                                <label for="realname">证件类型</label>
                                <input type="text"  class="pay-txt"  id="idtype" name="idtype" value="${user.idtype}"     placeholder="请输入您的证件类型">
                                <div id="realnameErrorDiv"></div>
                            </li>
                            <li>
                                <label for="realname">身份证号</label>
                                <input type="text"  class="pay-txt" id="idno" name="idno" value="${user.idno}"  placeholder="请输入您的身份证号">
                                <div id="w"></div>
                            </li>
                            <li>
                                <label for="realname">电子邮箱</label>
                                <input type="text"  class="pay-txt"  id="email" name="email" value="${user.email}"   placeholder="请输入您的电子邮箱">
                                <div id="a4"></div>
                            </li>
                            <li>
                                <label for="realname">真实姓名</label>
                                <input type="text"  class="pay-txt"  id="rname" name="rname" value="${user.rname}"   placeholder="请输入您的真实姓名">
                                <div id="a5"></div>
                            </li>
                            <li>
