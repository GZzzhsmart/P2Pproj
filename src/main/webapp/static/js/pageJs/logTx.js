...
$('#mytab').bootstrapTable({
    ...
    url: "/logTx/pager_criteria",//要请求数据的文件路径
        ...
        ,
        {
            ...
            formatter: function (value, row, index) {
                if(value==0) {
                    ...
                    return '<span style="color:crimson" >失败</span>';
                }else {
                    return '<span style="color:chartreuse" >未审核</span>';
                }
            }
        }
        ,
...
$('#search_btn').click(function () {
 ...
 $('#mytab').bootstrapTable('refresh', {url: '/logTx/pager_criteria',query:{date:date,rname:rname,dateTime:dateTime}});
})
function refush() {
    $('#mytab').bootstrapTable('refresh', {url: '/logTx/pager_criteria'});
}
