        ...
        <div class="text-box">
            <div class="text-content" id="text-content">
                ...
                <p class="mt10 cn_line">
                    <span style="font-family:Microsoft YaHei;color:#0aaae1;font-size:16px;">1、 什么是民间借贷？</span><br>
                ...
                <p class="mt10 cn_line">
                    <span style="font-family:Microsoft YaHei;color:#0aaae1;font-size:16px;">2、民间借贷是否合法？</span><br>
                ...
                <p class="mt10 cn_line">
                    <span style="font-family:Microsoft YaHei;color:#0aaae1;font-size:16px;">3、民间借贷的合同何时生效？</span><br>
                ...
                <p class="mt10 cn_line">
                    <span style="font-family:Microsoft YaHei;color:#0aaae1;font-size:16px;">4、民间借贷的利率怎么规定？</span><br>
                ...
                <p class="mt10 cn_line">
                    <span style="font-family:Microsoft YaHei;color:#0aaae1;font-size:16px;">5、什么是债权转让？</span><br>
                ...
                <p class="mt10 cn_line">
                    <span style="font-family:Microsoft YaHei;color:#0aaae1;font-size:16px;">6、债权转让是否合法？</span><br>
                ...
                <p class="mt10 cn_line">
                    <span style="font-family:Microsoft YaHei;color:#0aaae1;font-size:16px;">7、债权转让何时生效？</span><br>
                ...
                <p class="mt10 cn_line">
                    <span style="font-family:Microsoft YaHei;color:#0aaae1;font-size:16px;">8、什么是电子合同？</span><br>
                ...
                <p class="mt10 cn_line">
                    <span style="font-family:Microsoft YaHei;color:#0aaae1;font-size:16px;">9、电子合同实现形式是什么？</span><br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 我国《中华人民共和国合同法》第13条规定：“当事人订立合同，采取要约、承诺方式。” 电子合同的订立同样有这两个过程，且均以电子的形式完成，输入相关的信息符合预先设定的程序，计算机就可以自动做出相应的意思表示。（注：意思表示的电子化，是指在合同订立的过程中通过相关的电子方式表达自己意愿的一种行为，这种行为的表现方式是通过电子化形式实现的。《电子商务示范法》中将电子化的意思表示称之为“数据电文”）。
                </p>
                <p>
                    <br>
                </p>
                <p class="mt10 cn_line">
                    <span style="font-family:Microsoft YaHei;color:#0aaae1;font-size:16px;">10、电子合同有法律效力吗？</span><br>
