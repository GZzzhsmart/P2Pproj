        ...
        <div class="text-box">
            <div class="text-content" id="text-content">
                ...
                <ul class="clearfix join">
                    <li>
                        <div class="title">
                            <img src="<%=path%>/static/images/join_01.jpg" class="fl" style="float:left">
                    ...
                    <li>
                        <div class="title">
                            <img src="<%=path%>/static/images/join_02.jpg" class="fl" style="float:left">
                    ...
                    <li>
                        <div class="title">
                            <img src="<%=path%>/static/images/join_03.jpg" class="fl" style="float:left">
                            <span style="line-height:34px;font-family:Microsoft YaHei;color:#0aaae1;font-size:24px;">PHP程序员（数名）</span>
                        </div>
                        <p>
                            <span style="line-height:2;font-family:Microsoft YaHei;color:#0aaae1;font-size:18px;">岗位职责:</span>
                        </p>
                        ...
                        <p class="cn_line" style="text-indent:0;">
                            &nbsp;&nbsp;&nbsp;<span style="line-height:2;">1.学历不限，具有1年以上PHP开发经验。</span><br>
                    ...
                    <li>
                        <div class="title">
                            <img src="<%=path%>/static/images/join_04.jpg" class="fl" style="float:left">
                    ...
                    <li>
                        <div class="title">
                            <img src="<%=path%>/static/images/join_05.jpg" class="fl" style="float:left">
                    ...
                    <li>
                        <div class="title">
                            <img src="<%=path%>/static/images/join_06.jpg" class="fl" style="float:left">
                    ...
                    <li>
                        <div class="title">
                            <img src="<%=path%>/static/images/join_07.jpg" class="fl" style="float:left">
