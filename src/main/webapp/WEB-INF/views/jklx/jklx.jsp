        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" id="formadd">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="lxname" name="lxname" class="form-control" required="" aria-required="true"/>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal"  id="updateForm">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">借款类型名称:</label>
                        <div class="col-sm-8">
                            <input type="text"  name="lxname" class="form-control" required="" aria-required="true"/>
                        </div>
                    </div>
...
<script src="<%=path%>/static/js/pageJs/jklx.js"></script>
